...
namespace Aws_TestApiNet6.Controllers
{
    ...
    public class LoginController : ControllerBase
    {
        ...
        public LoginController(Base baseController, IConfiguration configuration, Seguridad seguridad)
        {
        ...
        public async Task<IActionResult> SignIn([FromBody] Dictionary<string, string> usuarioLogin)
        {
            ...
            try
            {
                ...
                usuarioLogin["IdAplicacion"] = _configuration.GetSection("IdAplicacion").Value; 

                usuarioLogin["Method"] = "uspLogin_skrs";
                usuarioLogin["Schema"] = "Seguridad";
                var _userInfo = await _baseController.ConsultaSimpleAsync(usuarioLogin);
                ...
                if (_userInfo.Count > 0)
                {
                    ...
                    List<Dictionary<string, object>> opciones = await _baseController.ConsultaSimpleAsync(usuarioLogin);
        ...
        {
            var menu = _seguridad.MenuUsuario(Convert.ToInt32(data["IdUsuario"]), _configuration.GetSection("IdAplicacion").Value );
        ...
        public async Task<IActionResult> ExisteIdOpcion(Dictionary<string, string> data)
        {
            ...
            try
            {
                ...
                var acciones = (await _baseController.ConsultaSimpleAsync(data)).ToList();
        ...
        public async Task<IActionResult> PermisosPorModulo([FromBody] Dictionary<string, string> data)
        {
            try
            {
                ...
                response["Data"] = await _baseController.ConsultaSimpleAsync(data);
        ...
        public async Task<IActionResult> Logout([FromBody] Dictionary<string, string> usuarioLogout)
        {
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(Token))
                {
                    ...
                    await _baseController.ConsultaSimpleAsync(usuarioLogout);
        ...
        public IActionResult CatEmpresas(Dictionary<string, string> datos)
        {
            ...
            try
            {
                ...
                response["Data"] = _baseController.ConsultaSimple(datos);
        ...
        public async Task<IActionResult> RecoveryPassword([FromBody] Dictionary<string, string> datos)
        {
            try
            {
                ...
                await _baseController.ConsultaSimpleAsync(datos);
        ...
        public async Task<IActionResult> ValidateTokenRecovery([FromBody] Dictionary<string, string> datos)
        {
            ...
            try
            {
                ...
                datos["Schema"] = "Seguridad";
                response = new Dictionary<string, object>();
                response["Data"] = await _baseController.ConsultaSimpleAsync(datos);
